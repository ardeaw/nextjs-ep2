  ...
  return (
    <header className ="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-[300px] flex  justify-center items-center">
      <div className='text-center'>
            <h1 className='text-white text-5xl'>NextJS Pokemon Finder</h1>            
            ...
            <form onSubmit={handleForm} className="flex mt-2">
              {/* <span className="flex">  */}
                <input 
                    ...
                    placeholder='Pokemaon Name...'
                    onChange={handleInput}
                />
                <button className='inline-flex mx-2 px-4 py-2 rounded-md bg-green-500 text-white shadow-md' type='submit'>Search</button>
              {/* </span>   */}
            </form>
